...
Para migrar completamente a v0.147.9 debes seguir los siguientes pasos (si no lo has hecho ya):
...
- reemplaza `:filename` por `:contentbasename`

Si tenías un `single.html` en tu directorio `layouts` y otro en `layouts/page`, debes seguir [estas instrucciones](https://discourse.gohugo.io/t/possible-bug-single-layout-for-pages-in-v0-147-9/55179/8).
